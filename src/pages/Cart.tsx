        ...
        {loading ? (
          ...
          cartItems.length > 0 && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              {/* Right Column: Redesigned Action Trigger (Task 4) */}
              <div className="bg-white border border-rose-100 rounded-3xl p-6 shadow-sm flex flex-col items-center justify-center text-center">
                <button
                  ...
                  className="w-full flex flex-col items-center justify-center bg-rose-900 hover:bg-rose-800 text-white py-4 px-6 rounded-2xl shadow-lg hover:shadow-xl active:scale-[0.98] transition cursor-pointer group"
                >
                  <span className="text-xl sm:text-2xl font-black uppercase tracking-wider text-amber-300 group-hover:scale-105 transition-transform">
                    CLICK HERE
                  </span>
                  <span className="text-xs sm:text-sm font-bold tracking-wide text-rose-100 mt-1">
